...
image::./shape_up_images/pitch_ex_1.png[Pitch Example 1]

image::./shape_up_images/pitch_ex_2.png[Pitch Example 2]
...
image::./shape_up_images/integrate1.png[integrate 1]
image::./shape_up_images/integrate2.png[integrate 2]
image::./shape_up_images/integrate3.png[integrate 3]
...
image::./shape_up_images/scopes_before.png[scopes before]
image::./shape_up_images/scopes_after.png[scopes after]
...
image::./shape_up_images/todo.jpg[todo]
...
image::./shape_up_images/hill1.png[Hill]

When you are communicating where you are on a scope, plot where you are on the hill.

image::./shape_up_images/hill2.png[Hill with scopes]
